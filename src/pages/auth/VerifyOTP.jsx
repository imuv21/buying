...
const VerifyOTP = () => {
    ...
    return (
        <Fragment>
            <Helmet>
                <title>Buying - Verify OTP</title>
                <meta name="description" content="Enter the OTP sent to your email or phone to verify your account and complete the registration process. Join Buying for exclusive deals and a seamless shopping experience." />
                <link rel="canonical" href="https://buying.netlify.app/verify-otp" />
            </Helmet>

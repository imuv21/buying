    ...
    return (
        <Fragment>
            <article className='backSection'>
                <ArrowBackIosNewIcon onClick={() => goBack()} />  <h1 className='textBig' style={{ textTransform: 'uppercase' }}>{productDetails?.category}</h1>
            </article>
            ...
            <section className='pdCont'>
                ...
                <article className='pdContDetail'>
                    ...
                    <div className="pdcartdetail">
                        ...
                        <button>Customize This Product</button>
                    </div>
                    <div className="pdSubContDetail">
            ...
            <section className='ratings'>
                ...
                <article className='ratingCont'>
                    ...
                    <div className='ratingBox g5'>
                        <button style={{ width: 'fit-content' }}>Write a review</button>
                    </div>
                </article>
            </section>
